...
public class RegistroPasajeroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registropasajero);
    ...
    private void GrabarPasajero() {
        ...
        if (ValidarVariables () ) {
            ...
            try {
                PreparedStatement pst=ConexionSQL.conexionDBSQL().prepareStatement(" EXEC [dbo].[SP_SGCDTP_Pasajero] @Type = 'I', @Nombre = '" + TextNombre + "', @Apellido_Paterno = '" + TextPaterno   +  "', @Apellido_Materno = '" + TextMaterno   +   "', @DNI = '" + TextDNI +  "', @celular = '" + TextCelular + "', @usuario = '" + TextUsuario + "', @Clave ='" + TextClave + "'"   );
               pst.executeUpdate();
                pst.close();
